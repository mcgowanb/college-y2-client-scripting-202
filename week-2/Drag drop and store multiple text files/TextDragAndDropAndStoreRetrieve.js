...
function storeFile()
{
	...
	var data = document.getElementById('dropzone').innerText;
	try{
...
function retrieveFile()
{
	...
	//Display the contents of the retrieved file in the <pre> element 'filetoget'
	document.getElementById('filetoget').innerText = data;
}
...
function writefiles(file)
{
	...
	//	Display the contents of the file
		document.getElementById('dropzone').innerText += reader.result;
   	};
